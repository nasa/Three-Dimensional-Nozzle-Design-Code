...
inline double pow (float x, double y) {return pow(double(x),y);}
inline double pow (double x, float y) {return pow(x,double(y));}
inline double atan2 (float x, double y) {return atan2(double(x),y);}
inline double atan2 (double x, float y) {return atan2(x,double(y));}
#endif /* _NR_UTIL_H_ */
